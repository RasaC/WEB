function init(){
   ...
   $('.datepicker').pickadate({
     ...
     labelMonthPrev: 'Buvęs mėnuo',
     labelMonthSelect: '{Pasirinkti mėnesį}',
     labelYearSelect: 'Pasirinkti metus',
     monthsFull: [ 'Sausis', 'Vasaris', 'Kovas', 'Balandis', 'Gegužė', 'Birželis', 'Liepa', 'Rugpjūtis',
     'Rugsėjis', 'Spalis', 'Lapkritis', 'Gruodis' ],
     monthsShort: [ 'Sau', 'Vas', 'Kov', 'Bal', 'Geg', 'Bir', 'Lie', 'Rugp', 'Rugs', 'Spa', 'Lap', 'Gruo' ],
     weekdaysFull: [ 'Sekmadienis', 'Pirmadienis', 'Antradienis', 'Trečiadienis', 'Ketvirtadienis',
    'Penktadienis', 'Šeštadienis' ],
     weekdaysShort: [ 'Sekm', 'Pir', 'Antr', 'Treč', 'Ketv', 'Penk', 'Šešt' ],
